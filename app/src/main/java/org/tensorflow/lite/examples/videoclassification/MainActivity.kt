...
class MainActivity : AppCompatActivity() {
    ...
    //private var t1: TextView = TODO()
    //private var t2: TextView = TODO()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //t1 = findViewById(R.id.activityTextArea)
        //t2 = findViewById(R.id.probabilityTextArea)
    ...
    /*private fun showResults(labels: List<Category>, inferenceTime: Long, inputFps: Float) {
        ...
        runOnUiThread {
            binding.bottomSheet.tvDetectedItem0.text = "ACTIVITY:  " + labels[0].label
            //t1.text = "Activity: " + labels[0].label
            score = df.format(labels[0].score*100)
            binding.bottomSheet.tvDetectedItem0Value.text = "ACCURACY:  " + score + "%"
            //t2.text = "Probability: " + score + "%"
        }
    }*/

    private fun showResults(labels: List<Category>) {
        val df = DecimalFormat("##")
        df.roundingMode = RoundingMode.DOWN
        var score :String
